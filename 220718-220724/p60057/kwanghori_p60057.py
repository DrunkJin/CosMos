...
def solution(s):
    ...
    for k in range(1, len(s)+1):  # 1부터 글자수까지 한개씩 tokenized
        arr = []
...
테스트 6 〉	통과 (0.06ms, 10MB)
테스트 7 〉	통과 (0.80ms, 10.2MB)
테스트 8 〉	통과 (0.59ms, 10.1MB)
테스트 9 〉	통과 (0.83ms, 10.2MB)
테스트 10 〉	통과 (2.98ms, 10.2MB)
테스트 11 〉	통과 (0.23ms, 10.2MB)
테스트 12 〉	통과 (0.13ms, 10.1MB)
테스트 13 〉	통과 (0.16ms, 10MB)
테스트 14 〉	통과 (0.84ms, 10.2MB)
테스트 15 〉	통과 (0.16ms, 10.2MB)
테스트 16 〉	통과 (0.02ms, 10.2MB)
테스트 17 〉	통과 (1.46ms, 10.2MB)
테스트 18 〉	통과 (1.41ms, 10.2MB)
테스트 19 〉	통과 (1.43ms, 10.2MB)
테스트 20 〉	통과 (3.18ms, 10.2MB)
테스트 21 〉	통과 (3.19ms, 10.2MB)
테스트 22 〉	통과 (3.21ms, 10.1MB)
테스트 23 〉	통과 (3.31ms, 10.2MB)
테스트 24 〉	통과 (2.93ms, 10.2MB)
테스트 25 〉	통과 (3.25ms, 10.1MB)
테스트 26 〉	통과 (3.16ms, 10.2MB)
테스트 27 〉	통과 (3.16ms, 10MB)
